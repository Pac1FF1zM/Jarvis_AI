...
9. после выбора победителя один раз проверяет `private_holdout.jsonl`, если он
   заполнен.
...
- `data/private_holdout.jsonl` — закрытая финальная проверка, которую нельзя
...
Правила качественного корпуса:

- начните минимум со 100–200 уникальных train-фраз на intent;
...
- не копируйте validation или private holdout в train после просмотра результата;
...
Не используйте private holdout для выбора этих значений.
