...
**Migration gates: FAIL.** Production routing не переключался. Выбран seed `17` только по validation; его migration Exact JAL — 39.75%.
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 17 | 1,050,494 | 13 | 33.10% | 39.75% | 55.75% | 50.00% | 0.00% | 0.00% |

Среднее Migration Exact JAL: **39.75% ± 0.00%**.

## Главные ошибки выбранного seed

- Wrong dialogue act: 190.
- Wrong arguments: 48.
...
|---|---:|---:|:---:|
| overall_exact_jal_accuracy | 39.75% | 84.00% | FAIL |
| single_exact_jal_accuracy | 20.00% | 87.00% | FAIL |
| steps_2_3_exact_jal_accuracy | 32.56% | 85.00% | FAIL |
...
- Новый Structured JSC, выбранный seed: 39.75%.
- Предыдущий direct Structured JSC (`9753746`): 12.00%; рост выбранного кандидата: +27.75%.
