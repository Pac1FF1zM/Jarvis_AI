...
**Migration gates: FAIL.** Production routing не переключался. Выбран seed `17` только по validation; его migration Exact JAL — 12.00%.
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 17 | 175,995 | 2 | 14.83% | 12.00% | 22.25% | 20.25% | 2.25% | 0.00% |
| 29 | 175,995 | 1 | 11.03% | 7.00% | 15.00% | 15.00% | 0.00% | 0.00% |
| 41 | 175,995 | 3 | 13.45% | 7.75% | 20.00% | 19.75% | 0.00% | 0.00% |

Среднее Migration Exact JAL: **8.92% ± 2.70%**.

## Главные ошибки выбранного seed

- Wrong dialogue act: 323.
- Wrong arguments: 18.
- Wrong tool sequence: 11.
- Validation-selected thresholds: `{'execution_threshold': 0.45, 'verifier_threshold': 0.4, 'parameter_threshold': 0.35, 'span_threshold': 0.2, 'missing_threshold': 0.35}`.

## Обязательные gates выбранного кандидата

| Gate | Actual | Target | Status |
|---|---:|---:|:---:|
| overall_exact_jal_accuracy | 12.00% | 84.00% | FAIL |
| single_exact_jal_accuracy | 17.50% | 87.00% | FAIL |
| steps_2_3_exact_jal_accuracy | 1.16% | 85.00% | FAIL |
| steps_4_5_exact_jal_accuracy | 1.25% | 82.00% | FAIL |
| multi_turn_exact_jal_accuracy | 0.00% | 87.00% | FAIL |
| schema_valid_rate | 100.00% | 100.00% | PASS |
| maximum_false_execution_rate | 2.25% | 0.20% | FAIL |
...
- Новый Structured JSC, выбранный seed: 12.00%.
